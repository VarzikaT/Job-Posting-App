    ...
    <div class="homepage-wrapper">
      <div class="posterarea">
        <div className="job-text">
          ...
          <p style={{ backgroundColor: "#303F60" }}>
      ...
      <div class="card-area">
        <div class="textbox">
          ...
          <p style={{ backgroundColor: "#ffffff" }}>
            ...
            Reprehenderit, delectus ad vero necessitatibus sit harum.
          </p>
        </div>
        <div class="textbox">
          ...
          <p style={{ backgroundColor: "#ffffff" }}>
            ...
            voluptatibus aspernatur, doloribus reiciendis non?
          </p>
        </div>
        <div class="textbox">
          ...
          <p style={{ backgroundColor: "#ffffff" }}>
            ...
            doloremque unde ad adipisci ab quam!
          </p>
        </div>
      </div>
      <div>
